...
const TabsData = (props) => {
    const { tabData, bindSubmitForm, setactiveTab, setCareId, 
            room_types, provided_services, setCareName, 
            isUpdate, facilities, setAvailableCareDetails,
            setAvailableServices, setSaveNextButton, save_next_button_enabled
        } = props
