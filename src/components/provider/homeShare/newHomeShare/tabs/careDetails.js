...
const CareDetails = (props) => {
    ...
    return (
        <CareDetails1 {...props} FormValues={FormValues} setFormValues={setFormValues} fieldDisabled={fieldDisabled}/>
    )
}
...
const CareDetails1 = (props) => {
    const { bindSubmitForm, room_types, care_id, setactiveTab, FormValues, setFormValues, setAvailableCareDetails, fieldDisabled } = props 
                ...
                {(formikProps) => {
                    ...
                    <div className="section-bottom">
                        <div className="four-inputs-holder">
                            <FormInput type="text" labelText="Total Rooms" name="no_of_rooms" placeholder="Enter no. of total rooms" disabled={fieldDisabled} required />
                            <FormInput type="text" labelText="Total No. of Beds" name="no_of_beds" disabled={fieldDisabled} placeholder="Enter no. of bedrooms" required />
