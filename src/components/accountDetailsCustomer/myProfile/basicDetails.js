...
const BasicDetails = (props) => {
    ...
    const getUserDetails = async () => {
        ...
        const { first_name, last_name, email, mobile, organization, profession, address } = response.data
            ...
            {({ setFieldValue }) => (
                <Form>
                    ...
                    </div>
                    {
                        ...
                        <>
                            <FormInput type="text" labelText="Address" name="address" id="address" placeholder="Enter Your Address"/>
                            <div className="two-inputs-holder">
                                <FormInput type="text" labelText="Organization Name" name="organization" id="organization" placeholder="Enter Your Organization Name" />
                                <FormInput type="text" labelText="Profession" name="profession" id="profession" placeholder="Enter Your Profession" />
                            </div>
                        </>
                    }
